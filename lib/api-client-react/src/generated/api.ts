...
export const getScanDocumentUrl = () => {
  ...
  return `/api/ai/scan-document`
}

/**
 * @summary Scan a document image with AI and extract key information
 */
export const scanDocument = async (scanDocumentInput: ScanDocumentInput, options?: Parameters<typeof customFetch>[1]): Promise<ScanDocumentResult> => {

  return customFetch<ScanDocumentResult>(getScanDocumentUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(scanDocumentInput)
  }
);}
...
export const getScanDocumentMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof scanDocument>>, TError,{data: BodyType<ScanDocumentInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof scanDocument>>, TError,{data: BodyType<ScanDocumentInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof scanDocument>>, {data: BodyType<ScanDocumentInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ScanDocumentMutationBody = BodyType<ScanDocumentInput>
...
export const useScanDocument = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof scanDocument>>, TError,{data: BodyType<ScanDocumentInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {data: BodyType<ScanDocumentInput>},
        TContext
      > => {
